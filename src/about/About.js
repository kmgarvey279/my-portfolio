          ...
          <Col sm={4}>
            ...
            <div className="about-section-bottom" id="skills-bottom">
              <div className="about-skill" id="skill-js">
                <img className="skill-icon" src={js} weight="20" height="20"/>
                <p>JavaScript</p>
              </div>
              <div className="about-skill" id="skill-c">
                <img className="skill-icon" src={cSharp} weight="20" height="20"/>
                <p>C#</p>
              </div>
              <div className="about-skill" id="skill-react">
                <img className="skill-icon" src={react} weight="20" height="20"/>
                <p>React</p>
              </div>
              <div className="about-skill">
                <img className="skill-icon" src={redux} weight="20" height="20"/>
                <p>Redux</p>
              </div>
              <div className="about-skill">
                <img className="skill-icon" src={html} weight="20" height="20"/>
                <p>HTML</p>
              </div>
              <div className="about-skill">
                <img className="skill-icon" src={css} weight="20" height="20"/>
                <p>CSS</p>
              </div>
              <div className="about-skill">
                <img className="skill-icon" src={angular} weight="20" height="20"/>
                <p>Angular</p>
              </div>
              <div className="about-skill">
                <img className="skill-icon" src={node} weight="20" height="20"/>
                <p>Node</p>
              </div>
              <div className="about-skill">
                <img className="skill-icon" src={dotNet} weight="20" height="20"/>
                <p>.NET</p>
              </div>
              <div className="about-skill">
                <img className="skill-icon" src={sql} weight="20" height="20"/>
                <p>MySQL</p>
              </div>
            </div>
          </Col>
